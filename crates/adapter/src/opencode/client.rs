...
use crate::opencode::{
    model::{
        api_key_entry::ApiKeyEntry, billing_info::BillingInfo, go_usage::GoUsage,
        subscription_plan::SubscriptionPlan, workspace::Workspace,
    },
    serverfn::{self, ServerFnError},
};
...
/// OpenCode 网页和 server function 适配器。
///
/// 只负责发现账户工作区、订阅、Go 用量和工作区内 key。
